              ...
              <Layout>
                <Layout.Section>
                  ...
                  >
                    ...
                    <Text as="p">
                      The first thing that you&apos;ll need to do is setup
                      Google Maps (a Google account is required). Google Maps
                      offers $200 free credit each month which is equivalent to
                      10000-15000 visits to your store locator (the exact value
                      depends on how many searches the user performs). While
                      this usage will be fine for a small shop, you might go
                      over this limit if your shop receives more traffic. We
                      have instructions to add Google Maps billing alerts and
                      quotas below.{' '}
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  . Give your project a meaningful name (eg.
                                  Store locator) and then click{' '}
                                  <Text as="span" fontWeight="bold">
                                    CREATE
                                  </Text>
                                  . Wait for the project to be created then
                                  select the project by clicking on{' '}
                                  <Text as="span" fontWeight="bold">
                                    SELECT PROJECT
                                  </Text>{' '}
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  Organization), name, address and billing
                                  details - click on{' '}
                                  <Text as="span" fontWeight="bold">
                                    START FREE
                                  </Text>{' '}
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  popup using the values in the images below.
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  with your API key. Copy the key and paste it
                                  in your{' '}
                                  <Link
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  `}</style>
                                  Next we&apos;ll add restrictions to the API
                                  key so that only your website and Neutek Store
                                  ...
                                  <Text as="span" fontWeight="bold">
                                    https://
                                    {shopsGetQuery.data.shop.customDomain}
                                  </Text>
                                  <br />
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  to activate your account. That&apos;s it -
                          ...
                          [
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  and click on the billing account associated
                                  with your project. If you followed the steps
                                  above to create your Google Maps API key,
                                  there should only be one billing account. If
                                  there are no billing accounts, you can create
                                  one by clicking on{' '}
                                  <Text as="span" fontWeight="bold">
                                    CREATE ACCOUNT
                                  </Text>{' '}
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  existing alert click on it. Otherwise, to
                                  create a new budget alert click on{' '}
                                  <Text as="span" fontWeight="bold">
                                    CREATE BUDGET
                                  </Text>
                                  .
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  After clicking on an existing budget or
                                  creating a new one you will be able to
                                  configure it. Give it a meaningful name (eg.
                                  Store locator), configure the{' '}
                                  <Text as="span" fontWeight="bold">
                                    Time range
                                  </Text>{' '}
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  would like to track the free Google Maps
                                  credit enter $200. Enter your value in the{' '}
                                  <Text as="span" fontWeight="bold">
                                    Target amount
                                  </Text>{' '}
                                  input. Click on{' '}
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  thresholds. These thresholds determine when
                                  the alert is sent. By default they trigger at
                                  50%, 90% and 100%. Once your done click on{' '}
                                  <Text as="span" fontWeight="bold">
                                    FINISH
                                  </Text>{' '}
                          ...
                          items={[
                            {
                              ...
                              description: (
                                <Text as="span" tone="critical">
                                  We don&apos;t recommend setting quotas first
                                  if you&apos;re planning on bulk importing your
                                  locations. It&apos;s prefereable to do the
                                  bulk import first and then add quotas.
                                </Text>
                              ),
                            },
                          ]}
              ...
              <Layout>
                <Layout.Section>
                  ...
                  >
                    ...
                    <Text as="p">
                      The next thing you need to do is setup your Shopify store
                      by adding your embed code. The process is different
                      depending if you have an Online Store 2.0 theme or an
                      Online Store 1.0 (aka vintage) theme. You can check if you
                      have an Online Store 2.0 or vintage theme by following the
                      instructions{' '}
                      <Link
                          ...
                          [
                            {
                              ...
                              description: (
                                <div>
                                  Copy your embed code from above by clicking
                                  the{' '}
                                  <Text as="span" fontWeight="bold">
                                    Copy
                                  </Text>{' '}
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  name (eg. Store locator) and make sure
                                  it&apos;s based on the{' '}
                                  <Text as="span" fontWeight="bold">
                                    Default page
                                  </Text>
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  . Once the custom liquid section is added to
                                  the page, you can paste the embed code you
                                  copied earlier in the{' '}
                                  <Text as="span" fontWeight="bold">
                                    Liquid code
                                  </Text>{' '}
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  ...
                                  Store locator) and select the template you
                            ...
                            },
                            {
                              ...
                              description: (
                                <div>
                                  Lastly, you should add the store locator to
                                  your navigation menu so users can find it.
                                  Open the{' '}
                                  <Link
