        ...
        <Layout>
          ...
          <Layout.Section>
            ...
            <Text as="p">
              ...
              handle any data associated with the App, specifically regarding
              visitor analytics.
            </Text>
          </Layout.Section>
          <Layout.Section>
          ...
          <Layout.Section>
            ...
            <Text as="p">
              The data collected is used solely for analytics purposes. This
              helps us understand how visitors interact with your storefront,
              enabling us to improve the App and enhance the user experience. We
              may analyze this data to generate reports on visitor activity, but
              these reports do not include any personally identifiable
              information.
            </Text>
          </Layout.Section>
          <Layout.Section>
            ...
            <Text as="p">
              ...
              data is only used internally to improve the App and provide
              insights to merchants.
            </Text>
          </Layout.Section>
          <Layout.Section>
            <Text as="h2" variant="headingMd">
            ...
            <Text as="p">
              ...
              purposes is securely stored and protected according to industry
              best practices. Access to this data is restricted to authorized
              personnel only.
            </Text>
          </Layout.Section>
          <Layout.Section>
